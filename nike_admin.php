    ...
    <header class="header">
        ...
        <nav class="navbar" id="fieldset-1" style="border:none;">
            ...
            <ul>
                ...
                <li><a href="index.php" class="navbar2">🚪Logout</a></li>
            </ul>
        </nav>
    ...
    <div class="product-container">
        ...
        <h2>Size:
            <select name="size" id="size" style="font-size: 20px;">
                ...
                <!-- Add options for other sizes -->
            </select>
        </h2>
        <img src="' . $picture . '" style="width: 300px; height: 300px;">
        <button type="button" onclick="showPopup(' . $sneaker_id . ', ' . $price . ', \'' . $table_name . '\')" id="fieldset-3" style="border:none;">Details</button>
        <button type="button" onclick="deleteProduct(' . $sneaker_id . ')">Delete</button>
    </div>';
            }
        } else {
