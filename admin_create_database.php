...
<body>
    ...
    <p style = "color:black; text-align: center; font-size: 35px;">📂 CREATE a Database </p>

    </fieldset>

    <fieldset>
        <h1>Create a Database</h1><br>
        <form method="post" action="admin_create_database.php">
            <label for="dbname" style = "font-size: 35px;">Database Name:</label>
            <input type="text" name="dbname" id="dbname" required style = "font-size: 25px;">
            <input type="submit" value="Create Database" style = "font-size: 25px;">
        </form>
        <br><br><br>
    </fieldset>
    ...
    <nav>
        <ul>
            <li id = "fieldset-1" style = "border:none;"><a href="admin_create_database.php" class="button button-large">📂 CREATE a Database</a></li>
            <li id = "fieldset-2" style = "border:none;"><a href="admin_create_table.php" class="button button-large">📄 CREATE a Table</a></li>
            <li id = "fieldset-1" style = "border:none;"><a href="admin_create_record.php" class="button button-large">📝 CREATE a Record:</a></li>
        </ul>
    </nav>
    </fieldset>
