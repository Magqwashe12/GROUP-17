...
<div class="product-container">
    ...
    $sql = "SELECT shoe_id, shoe_description, shoe_price, shoe_image_path FROM adidas";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $table_name = "adidas"; // Modify this line to use the correct table name
            ...
            echo '<form method="POST" action="' . $_SERVER['PHP_SELF'] . '">
                <div class="product" id="fieldset-1" style="border:none;">
                    ...
                    <a href= "user_login.php" ><button  type="button">Purchase</button> </a>
                </div>
            </form>';
        }
    } else {
...
<div class="selected-shoe-details">
    ...
    if (isset($_SESSION['selected_shoe_id'])) {
        ...
        $sql = "SELECT shoe_id, shoe_description, shoe_price, shoe_image_path FROM adidas WHERE shoe_id = $selected_shoe_id";
        $result = $conn->query($sql);
