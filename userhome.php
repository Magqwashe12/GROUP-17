...
<body>
    ...
    <p style = "color: green; padding-left: 600px; font-size: 35px;">You have Successfully logged in as User</p>
    <h1 class="h1"> RU Sneakers </h1>
    <h2 class="h2"> Step into Style, Stride with Confidence </h2>

    <img src="images/nike-jordan.gif" alt="nike-jordan" width="100%" height="600">
    ...
    <div>
        ...
        <img id="sneakers" src="images/slide_show/slide_show1.jpg" alt="sneakers" width="800" height="500">
        <div id="caption"></div>
        <div>
            <h2 class="p2">
    ...
    <fieldset style = "padding-top: 20px; padding-bottom: 20px;">
        ...
        <!-- Stylish button with click event to navigate -->
        <div id="caption"> Developer Section</div> <br><br>
        <button class="styled-button" type="button" onclick="navigateToPage()" style = "margin-left:250px;"> 📋 View Java scrip Navigator object</button>
    </fieldset>
