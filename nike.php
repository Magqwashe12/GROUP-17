...
<div class="product-container">
    ...
    $sql = "SELECT shoe_id, shoe_description, shoe_price, shoe_image_path FROM nike";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            $table_name = "nike"; // Modify this line to use the correct table name
...
<div class="selected-shoe-details">
    ...
    if (isset($_SESSION['selected_shoe_id'])) {
        ...
        $sql = "SELECT shoe_id, shoe_description, shoe_price, shoe_image_path FROM nike WHERE shoe_id = $selected_shoe_id";
        $result = $conn->query($sql);
